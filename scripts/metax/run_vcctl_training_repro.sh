...
TRAIN_DIR="${TRAIN_DIR:-/afs-grj/muxi-Megatron/Megatron-LM}"
TRAIN_SCRIPT="${TRAIN_SCRIPT:-train_qwen3_30B_A3B.sh}"
TRAIN_RESULT_ROOT="${TRAIN_RESULT_ROOT:-/afs-a3-weight-share/zhangcaixian/scale_up10000/pretrain_healthcheck/results/training_repro}"
POD_TRAIN_RESULT_ROOT="${POD_TRAIN_RESULT_ROOT:-/afs-grj/pretrain_healthcheck/results/training_repro}"
...
Common env:
  ...
  TRAIN_DIR               Training workdir inside pods. Default: /afs-grj/muxi-Megatron/Megatron-LM
  ...
  POD_TRAIN_RESULT_ROOT   Pod-visible result root. Default: /afs-grj/pretrain_healthcheck/results/training_repro
